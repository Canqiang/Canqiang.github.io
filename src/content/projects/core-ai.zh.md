...
Core-AI 是一个用于构建和运行 AI 智能体的开源框架，覆盖 SDK、终端界面、自托管服务端与 Web 应用。
...
公开项目将 SDK、独立终端 Agent、自托管服务端和 Web UI 组合在一起。其公开能力覆盖智能体与工具执行、MCP 集成、多智能体协作、记忆与知识、工作流、模型选择和链路追踪。
...
相关贡献经常贯穿后端、CLI、前端、自动化测试与运行环境验证。这种工作跨度体现了我作为 Core-AI 团队贡献者之一的角色。
